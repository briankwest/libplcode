...
pkgdatadir = $(datadir)/libplcode
pkgincludedir = $(includedir)/libplcode
pkglibdir = $(libdir)/libplcode
pkglibexecdir = $(libexecdir)/libplcode
...
check_PROGRAMS = test_plcode$(EXEEXT)
TESTS = test_plcode$(EXEEXT)
subdir = .
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(plcodeinclude_HEADERS) \
	$(am__DIST_COMMON)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_CLEAN_FILES = plcode.pc
...
am__installdirs = "$(DESTDIR)$(libdir)" "$(DESTDIR)$(pkgconfigdir)" \
	"$(DESTDIR)$(plcodeincludedir)"
LTLIBRARIES = $(lib_LTLIBRARIES)
libplcode_la_DEPENDENCIES =
am__dirstamp = $(am__leading_dot)dirstamp
am_libplcode_la_OBJECTS = src/libplcode_la-plcode_tables.lo \
	src/libplcode_la-plcode_golay.lo \
	src/libplcode_la-plcode_ctcss_enc.lo \
	src/libplcode_la-plcode_ctcss_dec.lo \
	src/libplcode_la-plcode_dcs_enc.lo \
	src/libplcode_la-plcode_dcs_dec.lo \
	src/libplcode_la-plcode_dtmf_enc.lo \
	src/libplcode_la-plcode_dtmf_dec.lo \
	src/libplcode_la-plcode_cwid_enc.lo \
	src/libplcode_la-plcode_cwid_dec.lo \
	src/libplcode_la-plcode_mcw_enc.lo \
	src/libplcode_la-plcode_mcw_dec.lo \
	src/libplcode_la-plcode_fskcw_enc.lo \
	src/libplcode_la-plcode_fskcw_dec.lo \
	src/libplcode_la-plcode_twotone_enc.lo \
	src/libplcode_la-plcode_twotone_dec.lo \
	src/libplcode_la-plcode_selcall_enc.lo \
	src/libplcode_la-plcode_selcall_dec.lo \
	src/libplcode_la-plcode_toneburst_enc.lo \
	src/libplcode_la-plcode_toneburst_dec.lo \
	src/libplcode_la-plcode_mdc1200_enc.lo \
	src/libplcode_la-plcode_mdc1200_dec.lo \
	src/libplcode_la-plcode_courtesy_enc.lo \
	src/libplcode_la-plcode_tone_enc.lo
libplcode_la_OBJECTS = $(am_libplcode_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
libplcode_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(libplcode_la_CFLAGS) \
	$(CFLAGS) $(libplcode_la_LDFLAGS) $(LDFLAGS) -o $@
am_test_plcode_OBJECTS = tests/test_plcode-test_main.$(OBJEXT) \
	tests/test_plcode-test_golay.$(OBJEXT) \
	tests/test_plcode-test_ctcss.$(OBJEXT) \
	tests/test_plcode-test_dcs.$(OBJEXT) \
	tests/test_plcode-test_dtmf.$(OBJEXT) \
	tests/test_plcode-test_cwid.$(OBJEXT) \
	tests/test_plcode-test_mcw.$(OBJEXT) \
	tests/test_plcode-test_fskcw.$(OBJEXT) \
	tests/test_plcode-test_twotone.$(OBJEXT) \
	tests/test_plcode-test_selcall.$(OBJEXT) \
	tests/test_plcode-test_toneburst.$(OBJEXT) \
	tests/test_plcode-test_mdc1200.$(OBJEXT) \
	tests/test_plcode-test_courtesy.$(OBJEXT)
test_plcode_OBJECTS = $(am_test_plcode_OBJECTS)
test_plcode_DEPENDENCIES = libplcode.la
test_plcode_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(test_plcode_CFLAGS) \
...
am__depfiles_remade =  \
	src/$(DEPDIR)/libplcode_la-plcode_courtesy_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_ctcss_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_ctcss_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_cwid_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_cwid_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_dcs_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_dcs_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_dtmf_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_dtmf_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_fskcw_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_fskcw_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_golay.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_mcw_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_mcw_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_mdc1200_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_mdc1200_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_selcall_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_selcall_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_tables.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_tone_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_toneburst_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_toneburst_enc.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_twotone_dec.Plo \
	src/$(DEPDIR)/libplcode_la-plcode_twotone_enc.Plo \
	tests/$(DEPDIR)/test_plcode-test_courtesy.Po \
	tests/$(DEPDIR)/test_plcode-test_ctcss.Po \
	tests/$(DEPDIR)/test_plcode-test_cwid.Po \
	tests/$(DEPDIR)/test_plcode-test_dcs.Po \
	tests/$(DEPDIR)/test_plcode-test_dtmf.Po \
	tests/$(DEPDIR)/test_plcode-test_fskcw.Po \
	tests/$(DEPDIR)/test_plcode-test_golay.Po \
	tests/$(DEPDIR)/test_plcode-test_main.Po \
	tests/$(DEPDIR)/test_plcode-test_mcw.Po \
	tests/$(DEPDIR)/test_plcode-test_mdc1200.Po \
	tests/$(DEPDIR)/test_plcode-test_selcall.Po \
	tests/$(DEPDIR)/test_plcode-test_toneburst.Po \
	tests/$(DEPDIR)/test_plcode-test_twotone.Po
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(libplcode_la_SOURCES) $(test_plcode_SOURCES)
DIST_SOURCES = $(libplcode_la_SOURCES) $(test_plcode_SOURCES)
...
TEST_LOG_COMPILE = $(TEST_LOG_COMPILER) $(AM_TEST_LOG_FLAGS) \
	$(TEST_LOG_FLAGS)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/plcode.pc.in \
...
# --- library -----------------------------------------------------------
lib_LTLIBRARIES = libplcode.la
libplcode_la_SOURCES = \
	src/plcode_tables.c \
	src/plcode_golay.c \
...
# --- public header ------------------------------------------------------
plcodeincludedir = $(includedir)
plcodeinclude_HEADERS = include/plcode.h

# --- pkg-config ---------------------------------------------------------
pkgconfigdir = $(libdir)/pkgconfig
pkgconfig_DATA = plcode.pc
test_plcode_SOURCES = \
	tests/test_main.c \
	tests/test_golay.c \
	tests/test_ctcss.c \
...
$(am__aclocal_m4_deps):
plcode.pc: $(top_builddir)/config.status $(srcdir)/plcode.pc.in
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: >>src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_tables.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_golay.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_ctcss_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_ctcss_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_dcs_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_dcs_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_dtmf_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_dtmf_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_cwid_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_cwid_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_mcw_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_mcw_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_fskcw_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_fskcw_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_twotone_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_twotone_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_selcall_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_selcall_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_toneburst_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_toneburst_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_mdc1200_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_mdc1200_dec.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_courtesy_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/libplcode_la-plcode_tone_enc.lo: src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)

libplcode.la: $(libplcode_la_OBJECTS) $(libplcode_la_DEPENDENCIES) $(EXTRA_libplcode_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libplcode_la_LINK) -rpath $(libdir) $(libplcode_la_OBJECTS) $(libplcode_la_LIBADD) $(LIBS)
tests/$(am__dirstamp):
	@$(MKDIR_P) tests
	@: >>tests/$(am__dirstamp)
tests/$(DEPDIR)/$(am__dirstamp):
	...
	@: >>tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_main.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_golay.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_ctcss.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_dcs.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_dtmf.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_cwid.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_mcw.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_fskcw.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_twotone.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_selcall.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_toneburst.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_mdc1200.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test_plcode-test_courtesy.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)

test_plcode$(EXEEXT): $(test_plcode_OBJECTS) $(test_plcode_DEPENDENCIES) $(EXTRA_test_plcode_DEPENDENCIES) 
	@rm -f test_plcode$(EXEEXT)
	$(AM_V_CCLD)$(test_plcode_LINK) $(test_plcode_OBJECTS) $(test_plcode_LDADD) $(LIBS)
...
install-plcodeincludeHEADERS: $(plcodeinclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(plcodeinclude_HEADERS)'; test -n "$(plcodeincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(plcodeincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(plcodeincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	...
	while read files; do \
	  echo " $(INSTALL_HEADER) $$files '$(DESTDIR)$(plcodeincludedir)'"; \
	  $(INSTALL_HEADER) $$files "$(DESTDIR)$(plcodeincludedir)" || exit $$?; \
	done

uninstall-plcodeincludeHEADERS:
	@$(NORMAL_UNINSTALL)
	@list='$(plcodeinclude_HEADERS)'; test -n "$(plcodeincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(plcodeincludedir)'; $(am__uninstall_files_from_dir)
...
recheck: all $(check_PROGRAMS)
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test_plcode.log: test_plcode$(EXEEXT)
	@p='test_plcode$(EXEEXT)'; \
	b='test_plcode'; \
...
installdirs:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(plcodeincludedir)"; do \
...
distclean: distclean-am
	...
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_courtesy_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_ctcss_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_ctcss_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_cwid_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_cwid_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_dcs_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_dcs_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_dtmf_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_dtmf_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_fskcw_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_fskcw_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_golay.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_mcw_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_mcw_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_mdc1200_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_mdc1200_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_selcall_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_selcall_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_tables.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_tone_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_toneburst_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_toneburst_enc.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_twotone_dec.Plo
	-rm -f src/$(DEPDIR)/libplcode_la-plcode_twotone_enc.Plo
	-rm -f tests/$(DEPDIR)/test_plcode-test_courtesy.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_ctcss.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_cwid.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_dcs.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_dtmf.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_fskcw.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_golay.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_main.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_mcw.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_mdc1200.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_selcall.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_toneburst.Po
	-rm -f tests/$(DEPDIR)/test_plcode-test_twotone.Po
	-rm -f Makefile
...
install-data-am: install-pkgconfigDATA install-plcodeincludeHEADERS
...
.PHONY: CTAGS GTAGS TAGS all all-am am--depfiles am--refresh check \
	...
	install-plcodeincludeHEADERS install-ps install-ps-am \
